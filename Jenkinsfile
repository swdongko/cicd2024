          ...
          steps {
                withCredentials([
                  ...
                  string(credentialsId: 'PRISMA_SECRET_KEY', variable: 'PRISMA_SECRET_KEY')
                   ...
                   token=$(curl -sSLk -d "$json_auth_data" -H 'content-type: application/json' "https://us-east1.cloud.twistlock.com/us-1-111573457/api/v32.06/authenticate" | python3 -c 'import sys, json; print(json.load(sys.stdin)["token"])')
